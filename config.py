...
# Recommended
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8387993797:AAGi0lku4Aq8BFU_DIv22TMcP2NxlRRMlVM")
APP_ID = int(os.environ.get("APP_ID", "26317075"))
API_HASH = os.environ.get("API_HASH", "9e3569975b5ea5832d9fb6a321c011b3")

# Main
OWNER_ID = int(os.environ.get("OWNER_ID", "7045232079"))
PORT = os.environ.get("PORT", "8080")

# Database
DB_URI = os.environ.get("DB_URI", "mongodb+srv://LD:LD@cluster0.otlfhrk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1002707052547")) # Channel where user links are stored
#--- ---- ---- --- --- --- - -- -  - - - - - - - - - - - --  - -

try:
    ADMINS = []
    for x in (os.environ.get("ADMINS", "491838168 7523534633 1428659469").split()):
        ADMINS.append(int(x))
except ValueError:
